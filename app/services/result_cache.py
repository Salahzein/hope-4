...
class ResultCache:
    ...
    def _generate_cache_key(self, query: str, business_type: str, time_range: str, user_id: str) -> str:
        """Generate a unique cache key for the search parameters"""
        return f"{query}_{business_type}_{time_range}_{user_id}"
    
    def get_cached_results(self, query: str, business_type: str, time_range: str, user_id: str) -> Optional[any]:
        """Get cached results if they exist and are fresh"""
        cache_key = self._generate_cache_key(query, business_type, time_range, user_id)
    ...
    def cache_results(self, query: str, business_type: str, time_range: str, user_id: str, results_with_age: Tuple[Any, float]):
    ...
    def should_refresh(self, query: str, business_type: str, time_range: str, user_id: str) -> bool:
